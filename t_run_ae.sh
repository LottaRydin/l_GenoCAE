...
singularity exec --nv --bind /proj/gcae_berzelius/users/kristiina:/mnt /proj/gcae_berzelius/users/filip/image_latest.sif python -u run_gcae_l.py train --datadir $datadir --data $data --model_id $model  --epochs 40 --save_interval 5 --train_opts_id $train_opts  --data_opts_id $data_opts --trainedmodeldir $trainedmodeldir 
#--random_state $random_seed

echo --------------------------- traning finished hopefully--------------------------

singularity exec --nv --bind /proj/gcae_berzelius/users/kristiina:/mnt /proj/gcae_berzelius/users/filip/image_latest.sif python -u run_gcae_l.py project --datadir $datadir --data $data --model_id $model --train_opts_id $train_opts  --data_opts_id $data_opts --trainedmodeldir $trainedmodeldir 
#--random_state $random_seed

...
do
	...
	sbatch --gpus=1 -t 20:00:00 -e ${taskname}.error -o ${taskname}.output -J $taskname run_ae.sh $datadir $data $model $train_opts $data_opts $epochs $save_interval $test_id $trainedmodeldir $save_interval_start $random_seed
done
done

...
class ResidualBlock2(tf.keras.layers.Layer):
	...
	def __init__(self, filters, kernel_size, name="res_block1"):
		...
		# # Extra layer because of concatination previously
	...
	def call(self, input_data):
		...
		'''
		#print(f"input: ")
		#print(input_data.shape == (2, 9259, 16))
		#print(f"input shape: {input_data.shape}")
		# print("--- adding {0} ".format(type(self.layers[0])))
		x = self.layers[0](input_data)

		# # After adding concatination
		# x_1 = self.layers[0](input_data)
		# x = x_1
		...
		# print("--- performing addition ")
		if input_data.shape == x.shape:
			x = tf.keras.layers.Add()([x, input_data])
		else:
			#print(f"new input shape: {input_data[:,:,:8].shape}")
			x = tf.keras.layers.Add()([x, input_data[:,:,:8]])

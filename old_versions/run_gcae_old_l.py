...
class Autoencoder(Model):
	...
	def __init__(self, model_architecture, n_markers, noise_std, regularizer):
		...
		print(f'layer_module:{type(layer_module)}')
		print(layer_module)
		...
		for layer_def in model_architecture["layers"][1:]:
			...
			for arg in ["size", "layers", "units", "shape", "target_shape", "output_shape", "kernel_size", "strides", "axis"]:
		...
		print('self.all_layers och self.ns:')
